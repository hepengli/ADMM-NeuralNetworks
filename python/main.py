...
# Initial Model
model = ADMM_NN(n_inputs, n_hiddens, n_outputs, n_agents, n_batches)

# Warming Model
model.warming(trainX, trainY, warm_epochs, beta, gamma, rho)
...
for i in range(train_epochs):
    ...
    loss_train, accuracy_train = model.fit(trainX, trainY, beta, gamma, rho)
